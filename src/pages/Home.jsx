  ...
  return (
    <Dialog className="contact-us" onClose={handleClose} open={open}>
      ...
      <List sx={{ pt: 0, flexDirection:{xs:"column",sm:"row"} }}>
        <ListItem>
          <a className="facebook" href="https://www.facebook.com/hamo.milano" target="_blank" rel="noreferrer">
            <span></span>
            <span></span>
            <span></span>
            <span></span>
        ...
        <ListItem>
          <a className="instagram" target="_blank" rel="noreferrer" href="https://www.instagram.com/milano.hamo/?igshid=MzRlODBiNWFlZA%3D%3D&fbclid=IwAR1XjaUP-fDPm7-EzjSKkGxG4Vij63BqgjHDe2GHcOfxtzV_9zwiuDOT6lo">
            <span></span>
            <span></span>
            <span></span>
            <span></span>
                  ...
                  >
                    ...
                    >
                      {pages.map((page) => (
                        ...
                        <MenuItem key={page.Name} onClick={(eo) => {
                          handleCloseNavMenu();
                          handleClickOpen();
                        }}>
                  ...
                  <Box sx={{ flexGrow: 0 }}>
                    <Tooltip title="Open settings">
                      <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                        <Avatar
                          alt="H"
                          src="./292606090_1210144579836175_6424786474028542165_n.jpg"
                        />
                      </IconButton>
                    </Tooltip>
                    <Menu
